// 国际化配置和翻译
export interface Translations {  // 通用
  common: {
    loading: string;
    error: string;
    success: string;
  ...
  divination: {
    ...
    questionTitle: string;    // Additional keys
    divinationResultCopied: string;
    copySuccess: string;
    divinationComplete: string;
    hexagramGenerated: string;
    quickActions: string;
...
// 中文翻译
export const zhTranslations: Translations = {  common: {
    loading: "加载中...",
    error: "错误",
    success: "成功",
    confirm: "确认",
  ...
  divination: {
    ...
    questionTitle: "问题",    // Additional keys
    divinationResultCopied: "占卜结果已复制",
    copySuccess: "复制成功",
    divinationComplete: "占卜完成",
    hexagramGenerated: "您的卦象已生成，请查看结果",
    quickActions: "快速操作",
    languageChanged: "语言已切换",
    dataRefreshed: "卦象数据已更新为当前语言",
    dataRefreshFailed: "切换语言后数据刷新失败",
  ...
  settings: {
    ...
    total: "历史记录",
    saveToHistory: "保存到历史",
    saveSuccess: "占卜结果已保存到历史记录",
    saveFailed: "无法保存到历史记录",
  },
...
// 英文翻译
export const enTranslations: Translations = {  common: {
    loading: "Loading...",
    error: "Error",
    success: "Success",
    confirm: "Confirm",
    ...
    next: "Next",
    close: "Close",
    copyFailed: "Cannot copy to clipboard",
  },
  ...
  divination: {
    ...
    questionTitle: "Question",    // Additional keys
    divinationResultCopied: "Divination result copied",
    copySuccess: "Copy successful",
    divinationComplete: "Divination complete",
    hexagramGenerated: "Your hexagram has been generated, please view the result",
    quickActions: "Quick Actions",
    languageChanged: "Language switched",
    dataRefreshed: "Hexagram data updated to current language",
    dataRefreshFailed: "Failed to refresh data after language switch",
  ...
  settings: {
    ...
    saveSuccess: "Divination result has been saved to history",
